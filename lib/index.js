...
function HTTPStatusCode() {
	...
	/**
	 * initialize the HTTPStatusCode by reading all the RFC json files
	 *
	 * @method init
	 * @return void
	 * @private
	 */
	function init() {
		fs.readdirSync('./json').forEach(function(filename) {
			var file = fs.readFileSync('./json/' + filename, {encoding: 'utf8'});
